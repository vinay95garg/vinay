...
$("#logout_submit").click(function()  {
	...
	var test="";
	$.post('slim_files/logout.php',{test:test}),done(function(data) {
...
$("#submit").click(function() {
	...
	//alert("bej");
	$.post('slim_files/checkLogin.php',{username : username,password: password}).done( function(data){
	...
	$('#infoSQL').text(message["msg"]);	
		...
		if(message["loggedin"] == "true") {
			...
			loginbutton.hide();
			logoutbutton.show();
		window.location	= "http://localhost/login/index.html";
