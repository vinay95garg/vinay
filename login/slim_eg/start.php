...
$app->get('/:schedule',function($id){
  ...
  $mtch_id=array("match_id"=>array(),"club_name1"=>array(),"club_name2"=>array());
    ...
    $query="SELECT * FROM personal_team_info where user_id='$uname'";
   ...
   // echo json_encode($cl_name);
    ...
    for($l=0;$l<sizeof($cl_name);$l++){
      ...
      $str1=strtolower($arr["club_name1"][$z]);
      $str2=strtolower($arr["club_name2"][$z]);
      $str3=strtolower($cl_name[$l]);

       if((strcmp($str1,$str3)==0) or (strcmp($str2,$str3)==0) ){
