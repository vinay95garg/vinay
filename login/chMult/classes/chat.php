	...
	public function DisplayMessagesInGame(){
		...
		if($existCount>0){
			while($rowChat=$ChatReq->fetch()){
				...
				$rowUser=$UserReq->fetch();
				?>
				<span class="UserNameS" style="color:red;font-size:18px;font-family:cursive;"> <?php echo $rowUser['UserName'];?> </span> says:
				<span class="ChatMessageS" style=" position:absolute;color:#A5E0D0;font-size:16px;font-family:cursive;padding:16px;"><?php echo $rowChat['ChatText'];?></span></br>
				<?php
