...
$(document).ready(function() {
    ...
    budget_id.setAttribute("value",705);
  ...
  $("#Goal-keeper").click (function() {
     ...
     if(gkcount%2==0){
        ...
        $.ajax({
            type: "GET",
            url: "/login/slim_files/dash_home.php/player/1",
...
$("#Defenders").click (function() {
     ...
     if(dfcount%2==0){
        ...
        $.ajax({
            type: "GET",
            url: "/login/slim_files/dash_home.php/player/2",
            data:data,
            success: 
                function(data) {
                    console.log(data);
    ...
    $("#Midfielders").click (function() {
     ...
     if(mfcount%2==0){
        ...
        $.ajax({
            type: "GET",
            url: "/login/slim_files/dash_home.php/player/3",
            data:data,
            success: 
                function(data) {
                    console.log(data);
    ...
    $("#Attackers").click (function() {
     ...
     if(atcount%2==0){
        ...
        $.ajax({
            type: "GET",
            url: "/login/slim_files/dash_home.php/player/4",
            data:data,
            success: 
                function(data) {
                    console.log(data);
